    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 via-white to-purple-100 py-12">
      ...
      {selectedListing && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-white/80 backdrop-blur-sm rounded-xl shadow-lg w-full max-w-4xl p-8">
            {/* Close button */}
            ...
            <div className="grid grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                ...
                <div className="relative">
                  ...
                  <div className="w-full p-4 border border-gray-300 rounded-lg bg-gray-50 min-h-[80px]">
                    {selectedListing.description}
                  </div>
                </div>

                {/* Nếu có lý do từ chối */}
                {/* {rejectReason && (
                  <div className="relative">
                    <label className="absolute -top-3 left-3 bg-white px-2 text-xs font-semibold text-red-700 uppercase tracking-wide">
                      Rejection Reason
                    </label>
                    <div className="w-full p-4 border border-red-300 rounded-lg bg-red-50 text-red-700 min-h-[60px]">
                      {rejectReason}
                    </div>
                  </div>
                )} */}
