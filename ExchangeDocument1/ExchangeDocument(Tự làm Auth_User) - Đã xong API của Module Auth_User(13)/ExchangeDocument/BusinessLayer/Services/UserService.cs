...
namespace ExchangeDocument.BusinessLayer.Services
{
    public class UserService : IUserService
    {
        ...
        public async Task<Result<PagedResponseDTO<UserProfileDTO>>> GetAllUsersAsync(int pageNumber, int pageSize)
        {
            ...
            var response = new PagedResponseDTO<UserProfileDTO>
            {
                Items = items,
            ...
            return Result<PagedResponseDTO<UserProfileDTO>>.Ok(response);
        }
