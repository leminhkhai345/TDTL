...
namespace ExchangeDocument.Migrations
{
    ...
    [Migration("20250605054832_AddSellerResponseToReview")]
    partial class AddSellerResponseToReview
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ExchangeDocument.DataAccessLayer.Entities.Review", b =>
                {
                    ...
                    b.Property<bool>("IsSellerResponseEdited")
                        .HasColumnType("bit")
                        .HasColumnName("isSellerResponseEdited");

                    b.Property<string>("ItemComment")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("itemComment");

                    b.Property<byte>("ItemRating")
                    ...
                    b.Property<int>("ReviewedDocumentId")
                        .HasColumnType("int")
                        .HasColumnName("reviewedDocumentId");

                    b.Property<int>("ReviewedListingId")
                        .HasColumnType("int")
                        .HasColumnName("reviewedListingId");

                    b.Property<int>("ReviewedSellerId")
                        .HasColumnType("int")
                        .HasColumnName("reviewedSellerId");
                    ...
                    b.Property<string>("SellerComment")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("sellerComment");

                    b.Property<byte>("SellerRating")
                        .HasColumnType("tinyint")
                    ...
                    b.Property<DateTime?>("SellerResponseDate")
                        .HasColumnType("datetime2")
                        .HasColumnName("sellerResponseDate");
                    ...
                    b.HasIndex("ReviewedDocumentId");

                    b.HasIndex("ReviewedListingId");
            ...
            modelBuilder.Entity("ExchangeDocument.DataAccessLayer.Entities.Review", b =>
                {
                    ...
                    b.HasOne("ExchangeDocument.DataAccessLayer.Entities.Document", "ReviewedDocument")
                        .WithMany("Reviews")
                        .HasForeignKey("ReviewedDocumentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_Reviews_Document");

                    b.HasOne("ExchangeDocument.DataAccessLayer.Entities.Listing", "ReviewedListing")
                        .WithMany()
                        .HasForeignKey("ReviewedListingId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_Reviews_Listing");

                    b.HasOne("ExchangeDocument.DataAccessLayer.Entities.User", "ReviewedSeller")
                        .WithMany("ReviewsReceived")
                        .HasForeignKey("ReviewedSellerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_Reviews_ReviewedSeller");
                    ...
                    b.Navigation("ReviewedDocument");

                    b.Navigation("ReviewedListing");
